...
enum MockData {
    static let mockSearchResponse = SearchResponseModel(
        tracks: TracksSearchResponse(
            href: "https://api.spotify.com/v1/search?type=track&query=mockquery",
            limit: 20,
            next: "https://api.spotify.com/v1/search?query=mockquery&type=track&offset=20&limit=20",
            offset: 0,
            previous: nil,
            total: 2,
            items: [
                    ...
                    album: Album(
                        ...
                        artists: [
                            Artist(
                                ...
                                id: "abcdefghij",
                                images: [ImageObject(url: "https://i.scdn.co/image/ab6761610000e5ababcdefghij", height: 640, width: 640)],
                                name: "Mock Artist",
                                popularity: 80,
                                type: "artist",
        ...
        playlists: PlaylistsResponse(
            href: "https://api.spotify.com/v1/search?type=playlist&query=mockquery",
            limit: 20,
            next: "https://api.spotify.com/v1/search?query=mockquery&type=playlist&offset=20&limit=20",
            offset: 0,
            previous: nil,
            total: 1,
            items: [
